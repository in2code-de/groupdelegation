...
$EM_CONF[$_EXTKEY] = [
    ...
    'category' => 'be',
    'author' => 'Sebastian Mueller, Bernhard Maier, Franz Kugelmann, Marcus Schwemer',
    'author_email' => 'sebastian.mueller@abezet.de, maier@tum.de, franz.kugelmann@elementare-teilchen.de, marcus@schwemer.de',
